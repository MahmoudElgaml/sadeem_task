...
class _CartRemote implements CartRemote {
  _CartRemote(
    this._dio, {
    this.baseUrl,
    this.errorLogger,
  ...
  @override
  Future<CartDto> getCartItems(String userId) async {
  ...
  @override
  Future<DeleteCartResponse> deleteCartItems(String cartId) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
  ...
  @override
  Future<Cart> addCartItems(AddCartRequestDto addCartRequestDto) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
